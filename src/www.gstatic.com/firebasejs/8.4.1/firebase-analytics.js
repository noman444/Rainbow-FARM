! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(require("@firebase/app")) : "function" == typeof define && define.amd ? define(["@firebase/app"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).firebase) }(this, function(mt) { "use strict"; try {! function() {
            function e(e) { return e && "object" == typeof e && "default" in e ? e : { default: e } } var t = e(mt),
                r = function(e, t) { return (r = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(e, t) { e.__proto__ = t } || function(e, t) { for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]) })(e, t) }; var c = function() { return (c = Object.assign || function(e) { for (var t, n = 1, r = arguments.length; n < r; n++)
            ...
            function s(e) { var t = "function" == typeof Symbol && Symbol.iterator,
                    n = t && e[t],
            ...
            function l() { var e = "object" == typeof chrome ? chrome.runtime : "object" == typeof browser ? browser.runtime : void 0; return "object" == typeof e && void 0 !== e.id }
            ...
            function f() { return !(!navigator || !navigator.cookieEnabled) } var i, o = "FirebaseError",
                u = (function(e, t) { if ("function" != typeof t && null !== t) throw new TypeError("Class extends value " + String(t) + " is not a constructor or null");
            ...
            function d(e, t, n) { t = i.call(this, t) || this; return t.code = e, t.customData = n, t.name = o, Object.setPrototypeOf(t, d.prototype), Error.captureStackTrace && Error.captureStackTrace(t, m.prototype.create), t } var m = (n.prototype.create = function(e) { for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n]; var r, i = t[0] || {},
                    ...
                    e = this.serviceName + ": " + e + " (" + o + ")."; return new u(o, e, i) }, n);
            ...
            N(x, "_index", ["name", "keyPath", "multiEntry", "unique"]), D(x, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]), A(x, "_index", IDBIndex, ["openCursor", "openKeyCursor"]), N(k, "_cursor", ["direction", "key", "primaryKey", "value"]), D(k, "_cursor", IDBCursor, ["update", "delete"]), ["advance", "continue", "continuePrimaryKey"].forEach(function(n) { n in IDBCursor.prototype && (k.prototype[n] = function() { var t = this,
                ...
                [j, x].forEach(function(e) { i in e.prototype && (e.prototype[i.replace("open", "iterate")] = function() { var e = (n = arguments, Array.prototype.slice.call(n)),
                        ...
                        i = []; return new Promise(function(t) { r.iterateCursor(e, function(e) { e ? (i.push(e.value), void 0 === n || i.length != n ? e.continue() : t(i)) : t(i) }) }) }) }); var M = "0.4.25",
                B = 1e4,
                H = "w:" + M,
                q = "FIS_v2",
            ...
            function W(e) { return e instanceof u && e.code.includes("request-failed") }
            ...
            function ee(e) { return btoa(String.fromCharCode.apply(String, a([], function(e, t) { var n = "function" == typeof Symbol && e[Symbol.iterator]; if (!n) return e; var r, i, o = n.call(e),
                        a = []; try { for (;
            ...
            function re() { try { var e = new Uint8Array(17);
                    ...
                    e = ee(e).substr(0, 22); return te.test(e) ? e : ne } catch (e) { return ne } }
            ...
            function se(e, t) { var n, r, i = oe.get(e); if (i) try { for (var o = s(i), a = o.next(); !a.done; a = o.next())(0, a.value)(t) } catch (e) { n = { error: e } } finally { try { a && !a.done && (r = o.return) && r.call(o) } finally { if (n) throw n.error } } } var ue = null;
            ...
            function me() { var e, t, n; return ge || (e = he, t = function(e) { 0 === e.oldVersion && e.createObjectStore(ve) }, (n = (e = O(indexedDB, "open", [pe, e])).request) && (n.onupgradeneeded = function(e) { t && t(new R(n.result, e.oldVersion, n.transaction)) }), ge = e.then(function(e) { return new F(e) })), ge }
            ...
            function Se(i, o) { return void 0 === o && (o = !1), p(this, void 0, void 0, function() { var r, t, n; return h(this, function(e) { switch (e.label) {
                            case 0:
                                return [4, we(i.appConfig, function(e) { if (!Oe(e)) throw U.create("not-registered"); var t, n = e.authToken; if (o || 2 !== (t = n).requestStatus || function(e) { var t = Date.now(); return t < e.creationTime || e.creationTime + e.expiresIn < t + G }(t)) { if (1 === n.requestStatus) return r = function(n, r) { return p(this, void 0, void 0, function() { var t; return h(this, function(e) { switch (e.label) {
                                        ...
                                        n = (t = e, n = { requestStatus: 1, requestTime: Date.now() }, c(c({}, t), { authToken: n })); return r = function(i, o) { return p(this, void 0, void 0, function() { var t, n, r; return h(this, function(e) { switch (e.label) {
                                                        case 0:
                                                            return e.trys.push([0, 3, , 8]), [4, Te(i, o)];
                                                        case 1:
                                                            return t = e.sent(), r = c(c({}, o), { authToken: t }), [4, ye(i.appConfig, r)];
                                                        case 2:
                                                            return e.sent(), [2, t];
                                                        case 3:
                                                        ...
                                                        case 4:
                                                            return e.sent(), [3, 7];
                                                        case 5:
                                                            return r = c(c({}, o), { authToken: { requestStatus: 0 } }), [4, ye(i.appConfig, r)];
                                                        case 6:
                                                            e.sent(), e.label = 7;
                                                        case 7:
                                                            throw n;
            ...
            function Ce(e) { return we(e, function(e) { if (!Oe(e)) throw U.create("not-registered"); var t = e.authToken; return 1 === (t = t).requestStatus && t.requestTime + B < Date.now() ? c(c({}, e), { authToken: { requestStatus: 0 } }) : e }) }
            ...
            function Ae(e) { return U.create("missing-app-config-values", { valueName: e }) }(fe = t.default).INTERNAL.registerComponent(new T("installations", function(e) { var t = e.getProvider("app").getImmediate(),
                    n = { appConfig: function(e) { var t, n; if (!e || !e.options) throw Ae("App Configuration"); if (!e.name) throw Ae("App Name"); try { for (var r = s(["projectId", "apiKey", "appId"]), i = r.next(); !i.done; i = r.next()) { var o = i.value; if (!e.options[o]) throw Ae(o) } } catch (e) { t = { error: e } } finally { try { i && !i.done && (n = r.return) && n.call(r) } finally { if (t) throw t.error } } return { appName: e.name, projectId: e.options.projectId, apiKey: e.options.apiKey, appId: e.options.appId } }(t), platformLoggerProvider: e.getProvider("platform-logger") }; return { app: t, getId: function() { return function(r) { return p(this, void 0, void 0, function() { var t, n; return h(this, function(e) { switch (e.label) {
                                        case 0:
            ...
            function xe(e, t) { for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r]; if (!(t < e.logLevel)) { var i = (new Date).toISOString(),
                    ...
                    console[o].apply(console, a(["[" + i + "]  " + e.name + ":"], n)) } } var ke = { debug: de.DEBUG, verbose: de.VERBOSE, info: de.INFO, warn: de.WARN, error: de.ERROR, silent: de.SILENT },
                je = de.INFO,
                ...
                Re = (Object.defineProperty(Fe.prototype, "logLevel", { get: function() { return this._logLevel }, set: function(e) { if (!(e in de)) throw new TypeError('Invalid value "' + e + '" assigned to `logLevel`');
                    ...
                    this._userLogHandler && this._userLogHandler.apply(this, a([this, de.DEBUG], e)), this._logHandler.apply(this, a([this, de.DEBUG], e)) }, Fe.prototype.log = function() { for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    this._userLogHandler && this._userLogHandler.apply(this, a([this, de.VERBOSE], e)), this._logHandler.apply(this, a([this, de.VERBOSE], e)) }, Fe.prototype.info = function() { for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    this._userLogHandler && this._userLogHandler.apply(this, a([this, de.INFO], e)), this._logHandler.apply(this, a([this, de.INFO], e)) }, Fe.prototype.warn = function() { for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    this._userLogHandler && this._userLogHandler.apply(this, a([this, de.WARN], e)), this._logHandler.apply(this, a([this, de.WARN], e)) }, Fe.prototype.error = function() { for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    this._userLogHandler && this._userLogHandler.apply(this, a([this, de.ERROR], e)), this._logHandler.apply(this, a([this, de.ERROR], e)) }, Fe);
            ...
            function et(e) { if (e instanceof u && e.customData) { e = Number(e.customData.httpStatus); return 429 === e || 500 === e || 503 === e || 504 === e } } var tt = (nt.prototype.addEventListener = function(e) { this.listeners.push(e) }, nt.prototype.abort = function() { this.listeners.forEach(function(e) { return e() }) }, nt);
            ...
            function pt(e, t) { i = [], l() && i.push("This is a browser extension environment."), f() || i.push("Cookies are not available."), 0 < i.length && (i = i.map(function(e, t) { return "(" + (t + 1) + ") " + e }).join(" "), i = $e.create("invalid-analytics-context", { errorInfo: i }), Ue.warn(i.message)); var n, r, i, o, a, s, u = e.options.appId; if (!u) throw $e.create("no-app-id"); if (!e.options.apiKey) { if (!e.options.measurementId) throw $e.create("no-api-key");
                    ...
                    window[o].push(arguments) }, window[a] && "function" == typeof window[a] && (s = window[a]), window[a] = We(s, n, r, i), a = { gtagCore: s, wrappedGtag: window[a] }, ot = a.wrappedGtag, it = a.gtagCore, ft = !0), at[u] = rt(e, st, ut, t, it, ct), { app: e, logEvent: function(e, t, n) {! function(n, r, i, o, a) { return p(this, void 0, void 0, function() { var t; return h(this, function(e) { switch (e.label) {
                                        ...
                                        case 1:
                                            return [4, r];
                                        case 2:
                                            t = e.sent(), t = c(c({}, o), { send_to: t }), n(Me.EVENT, i, t), e.label = 3;
                                        case 3:
                                            return [2] } }) }) }(ot, at[u], e, t, n).catch(function(e) { return Ue.error(e) }) }, setCurrentScreen: function(e, t) {! function(n, r, i, o) { return p(this, void 0, void 0, function() { var t; return h(this, function(e) { switch (e.label) {
                                        case 0:
                                        ...
                                        case 3:
                                            return [2] } }) }) }(ot, at[u], e, t).catch(function(e) { return Ue.error(e) }) }, setUserId: function(e, t) {! function(n, r, i, o) { return p(this, void 0, void 0, function() { var t; return h(this, function(e) { switch (e.label) {
                                        case 0:
                                        ...
                                        case 3:
                                            return [2] } }) }) }(ot, at[u], e, t).catch(function(e) { return Ue.error(e) }) }, setUserProperties: function(e, t) {! function(a, s, u, c) { return p(this, void 0, void 0, function() { var t, n, r, i, o; return h(this, function(e) { switch (e.label) {
                                        case 0:
                                        ...
                                        case 3:
                                            return [2] } }) }) }(ot, at[u], e, t).catch(function(e) { return Ue.error(e) }) }, setAnalyticsCollectionEnabled: function(e) {! function(n, r) { return p(this, void 0, void 0, function() { var t; return h(this, function(e) { switch (e.label) {
                                        case 0:
                                            return [4, n];
                                        case 1:
                                            return t = e.sent(), window["ga-disable-" + t] = !r, [2] } }) }) }(at[u], e).catch(function(e) { return Ue.error(e) }) }, INTERNAL: { delete: function() { return delete at[u], Promise.resolve() } } } } var ht, vt = "analytics";

            function gt() { return p(this, void 0, void 0, function() { return h(this, function(e) { switch (e.label) {
                            case 0:
                                if (l()) return [2, !1]; if (!f()) return [2, !1]; if (!v()) return [2, !1];
                                e.label = 1;
                            case 1:
                                return e.trys.push([1, 3, , 4]), [4, g()];
                            case 2:
